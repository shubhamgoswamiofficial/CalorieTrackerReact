...
import { register } from '../../config/services/usersService';
...
class Register extends Component {
    ...
    handleChange = (event) => {
        this.setState({
            ...
            errors: false, validationError: '', emailErrorMsg: '', passwordErrorMsg: ''
        })
    }
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-title">
                                        <h3 id="cm_message">User Registration</h3>
                                    ...
                                    <form onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="form-group">
                                            <div className="row">
                                                <div className="col"><button className="btn btn-primary" type="submit">Sign Up</button></div>
                                                <div className="col text-right pt-2"><Link to="/login">Already have an account? SignIn</Link></div>
                                            </div>
                                        </div>
